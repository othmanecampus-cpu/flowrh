...
async function fetchAppUser(supabaseUser: SupabaseUser): Promise<AppUser | null> {
  ...
  // On enlève la sécurité qui bloque si le profil n'existe pas encore
  ...
  return {
    ...
    // --- MODIFICATIONS POUR FORCER L'ACCÈS ---

    role: "admin_gestionnaire", // On te donne les droits Admin

    approved: true,             // On force la validation (plus de sablier)
...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  const signup = async (email: string, password: string, fullName: string): Promise<string | null> => {
    ...
    // Restriction désactivée temporairement pour tes tests si besoin
