...
// --- SECTION MODIFIÉE POUR LE LOGO ---
const SidebarHeader = React.forwardRef<HTMLDivElement, React.ComponentProps<"div">>(({ className, children, ...props }, ref) => {
  return (
    <div ref={ref} data-sidebar="header" className={cn("flex flex-col gap-2 p-4", className)} {...props}>
      <div className="flex items-center justify-start">
        <img 
          src="/Flow RH.png" 
          alt="Logo Flow RH" 
          className="h-10 w-auto object-contain transition-all duration-200 group-data-[state=collapsed]:h-6" 
        />
      </div>
      {children}
    </div>
